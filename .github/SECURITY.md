...
Instead, report it privately using this repository�s [GitHub private vulnerability reporting tool](https://github.com/soenneker/soenneker.unified.runners.openapiclient/security/advisories/new).
