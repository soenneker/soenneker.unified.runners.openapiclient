...
using Soenneker.Unified.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.Unified.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["Unified:ClientGenerationUrl"] ?? "https://api.unified.to/openapi.json";
        ...
        await _kiotaUtil.Generate(fixedFilePath, "UnifiedOpenApiClient", Constants.Library, gitDirectory, cancellationToken).NoSync();
